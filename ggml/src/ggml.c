...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO3_1] = {
        .type_name                = "turbo3_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo3_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo3_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_turbo3_1_ref,
    },
    [GGML_TYPE_TURBO4_1] = {
        .type_name                = "turbo4_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo4_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_turbo4_1_ref,
    },
    [GGML_TYPE_TURBO5_1] = {
        .type_name                = "turbo5_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo5_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo5_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_turbo5_1_ref,
    },
    [GGML_TYPE_TURBO6_1] = {
        .type_name                = "turbo6_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo6_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo6_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_turbo6_1_ref,
    },
    [GGML_TYPE_RQ3_1] = {
        .type_name                = "rq3_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_rq3_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_rq3_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_rq3_1_ref,
    },
    [GGML_TYPE_RQ4_1] = {
        .type_name                = "rq4_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_rq4_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_rq4_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_rq4_1_ref,
    },
    [GGML_TYPE_RQ5_1] = {
        .type_name                = "rq5_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_rq5_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_rq5_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_rq5_1_ref,
    },
    [GGML_TYPE_RQ6_1] = {
        .type_name                = "rq6_1",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_rq6_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_rq6_1,
        .from_float_ref           = (ggml_from_float_t)quantize_row_rq6_1_ref,
    },
    [GGML_TYPE_TURBO3_0] = {
        .type_name                = "turbo3_0",
