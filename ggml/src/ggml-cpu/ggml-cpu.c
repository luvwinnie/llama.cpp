...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO3_1] = {
        .from_float               = quantize_row_turbo3_1,
        .vec_dot                  = ggml_vec_dot_turbo3_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO4_1] = {
        .from_float               = quantize_row_turbo4_1,
        .vec_dot                  = ggml_vec_dot_turbo4_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO5_1] = {
        .from_float               = quantize_row_turbo5_1,
        .vec_dot                  = ggml_vec_dot_turbo5_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO6_1] = {
        .from_float               = quantize_row_turbo6_1,
        .vec_dot                  = ggml_vec_dot_turbo6_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_RQ3_1] = {
        .from_float               = quantize_row_rq3_1,
        .vec_dot                  = ggml_vec_dot_rq3_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_RQ4_1] = {
        .from_float               = quantize_row_rq4_1,
        .vec_dot                  = ggml_vec_dot_rq4_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_RQ5_1] = {
        .from_float               = quantize_row_rq5_1,
        .vec_dot                  = ggml_vec_dot_rq5_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_RQ6_1] = {
        .from_float               = quantize_row_rq6_1,
        .vec_dot                  = ggml_vec_dot_rq6_1_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO3_0] = {
